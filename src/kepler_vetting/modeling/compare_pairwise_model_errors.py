...
MODEL_SPECS = {
    ...
    "three_class_fused_tabular_local_cnn": ModelSpec(
    ...
    "fused_tabular_residual_local_cnn": ModelSpec(
    ...
    "fused_tabular_multiscale_local_cnn": ModelSpec(
    ...
    "fused_tabular_local_transit_set_cnn": ModelSpec(
    ...
    "rescue_stacked_logistic_regression": ModelSpec(
...
PAIR_SPECS = [
    ...
    PairSpec(
        pair_id="fused_vs_three_class_fused_local",
        left=MODEL_SPECS["fused_tabular_local_cnn"],
    ...
    PairSpec(
        pair_id="soft_label_fused_local_vs_three_class_fused_local",
        left=MODEL_SPECS["soft_label_fused_tabular_local_cnn"],
        right=MODEL_SPECS["three_class_fused_tabular_local_cnn"],
    ),
    PairSpec(
        pair_id="candidate_weighted_fused_local_vs_three_class_fused_local",
        left=MODEL_SPECS["candidate_weighted_fused_tabular_local_cnn"],
        right=MODEL_SPECS["three_class_fused_tabular_local_cnn"],
    ),
    PairSpec(
    ...
    PairSpec(
        pair_id="tabular_vs_fused_residual_local",
        left=MODEL_SPECS["tabular_logistic_regression"],
        right=MODEL_SPECS["fused_tabular_residual_local_cnn"],
    ),
    PairSpec(
        pair_id="tabular_local_features_vs_fused_residual_local",
        left=MODEL_SPECS["tabular_local_features_logistic_regression"],
        right=MODEL_SPECS["fused_tabular_residual_local_cnn"],
    ),
    PairSpec(
        pair_id="fused_vs_fused_residual_local",
        left=MODEL_SPECS["fused_tabular_local_cnn"],
        right=MODEL_SPECS["fused_tabular_residual_local_cnn"],
    ),
    PairSpec(
        pair_id="tabular_vs_fused_multiscale_local",
        left=MODEL_SPECS["tabular_logistic_regression"],
        right=MODEL_SPECS["fused_tabular_multiscale_local_cnn"],
    ),
    PairSpec(
        pair_id="tabular_local_features_vs_fused_multiscale_local",
        left=MODEL_SPECS["tabular_local_features_logistic_regression"],
        right=MODEL_SPECS["fused_tabular_multiscale_local_cnn"],
    ),
    PairSpec(
        pair_id="fused_vs_fused_multiscale_local",
        left=MODEL_SPECS["fused_tabular_local_cnn"],
        right=MODEL_SPECS["fused_tabular_multiscale_local_cnn"],
    ),
    PairSpec(
        pair_id="fused_residual_local_vs_fused_multiscale_local",
    ...
    PairSpec(
        pair_id="tabular_vs_fused_local_transit_set",
        left=MODEL_SPECS["tabular_logistic_regression"],
        right=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
    ),
    PairSpec(
        pair_id="tabular_local_features_vs_fused_local_transit_set",
        left=MODEL_SPECS["tabular_local_features_logistic_regression"],
        right=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
    ),
    PairSpec(
        pair_id="fused_vs_fused_local_transit_set",
        left=MODEL_SPECS["fused_tabular_local_cnn"],
        right=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
    ),
    PairSpec(
        pair_id="fused_residual_local_vs_fused_local_transit_set",
        left=MODEL_SPECS["fused_tabular_residual_local_cnn"],
        right=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
    ),
    PairSpec(
        pair_id="fused_multiscale_local_vs_fused_local_transit_set",
        left=MODEL_SPECS["fused_tabular_multiscale_local_cnn"],
        right=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
    ),
    PairSpec(
        pair_id="fused_transit_set_vs_fused_local_transit_set",
        left=MODEL_SPECS["fused_tabular_transit_set_cnn"],
        right=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
    ),
    PairSpec(
        pair_id="tabular_vs_rescue_stacked",
        left=MODEL_SPECS["tabular_logistic_regression"],
        right=MODEL_SPECS["rescue_stacked_logistic_regression"],
    ),
    PairSpec(
        pair_id="tabular_local_features_vs_rescue_stacked",
        left=MODEL_SPECS["tabular_local_features_logistic_regression"],
        right=MODEL_SPECS["rescue_stacked_logistic_regression"],
    ),
    PairSpec(
        pair_id="fused_vs_rescue_stacked",
        left=MODEL_SPECS["fused_tabular_local_cnn"],
        right=MODEL_SPECS["rescue_stacked_logistic_regression"],
    ),
    PairSpec(
        pair_id="fused_transit_set_vs_rescue_stacked",
        left=MODEL_SPECS["fused_tabular_transit_set_cnn"],
        right=MODEL_SPECS["rescue_stacked_logistic_regression"],
    ),
    PairSpec(
        pair_id="fused_local_transit_set_vs_rescue_stacked",
        left=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
        right=MODEL_SPECS["rescue_stacked_logistic_regression"],
    ),
    PairSpec(
    ...
    PairSpec(
        pair_id="fused_residual_local_vs_stacked",
        left=MODEL_SPECS["fused_tabular_residual_local_cnn"],
        right=MODEL_SPECS["stacked_score_logistic_regression"],
    ),
    PairSpec(
    ...
    PairSpec(
        pair_id="fused_local_transit_set_vs_stacked",
        left=MODEL_SPECS["fused_tabular_local_transit_set_cnn"],
        right=MODEL_SPECS["stacked_score_logistic_regression"],
    ),
]
