...
PREDICTION_SOURCES = [
    ...
    {
        "family": "soft_label_fused_local",
        "path": SOFT_LABEL_FUSED_LOCAL_PREDICTIONS_PATH,
        "models": [
    ...
    {
        "family": "three_class_fused_local",
        "path": THREE_CLASS_FUSED_LOCAL_PREDICTIONS_PATH,
        "models": [
            "three_class_fused_tabular_local_cnn",
        ],
    },
    {
        "family": "two_stage_rescue_gate",
        "path": TWO_STAGE_RESCUE_GATE_PREDICTIONS_PATH,
        "models": [
    ...
    {
        "family": "fused_multiscale_local",
        "path": FUSED_MULTISCALE_LOCAL_PREDICTIONS_PATH,
        "models": [
            "fused_tabular_multiscale_local_cnn",
        ],
    },
    {
    ...
    {
        "family": "fused_local_transit_set",
        "path": FUSED_LOCAL_TRANSIT_SET_PREDICTIONS_PATH,
        "models": [
            "fused_tabular_local_transit_set_cnn",
        ],
    },
    {
        "family": "rescue_stacked",
        "path": RESCUE_STACKED_PREDICTIONS_PATH,
        "models": [
...
DISPLAY_NAMES = {
    ...
    "three_class_fused_tabular_local_cnn": "three_class_fused_tabular_local_cnn",
    "two_stage_rescue_gate": "two_stage_rescue_gate",
...
MODEL_ORDER = {
    ...
    "three_class_fused_tabular_local_cnn": 8,
    "two_stage_rescue_gate": 9,
    "fused_tabular_local_features_cnn": 10,
    "fused_tabular_residual_local_cnn": 11,
    "fused_tabular_multiscale_local_cnn": 12,
    "fused_tabular_transit_set_cnn": 13,
    "fused_tabular_local_transit_set_cnn": 14,
    "stacked_score_logistic_regression": 15,
    "rescue_stacked_logistic_regression": 16,
    "selective_rescue_rule_model": 17,
}
